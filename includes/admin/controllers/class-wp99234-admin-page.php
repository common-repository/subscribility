<?php
/**
 * Admin Page: Contains a number of functions
 *
 * @author      WP99234
 * @category    Admin
...
if ( ! class_exists( 'WP99234_Admin_Page' ) ) :

/**
 * WC_Admin_Dashboard Class.
 */
abstract class WP99234_Admin_Page {
	...
	public static function show_messages() {
		if ( sizeof( self::$errors ) > 0 ) {
			...
			foreach ( self::$messages as $message ) {
				echo '<div id="message" class="notice updated inline"><p><strong>' . esc_html( $message ) . '</strong></p></div>';
			}
		}
	}
